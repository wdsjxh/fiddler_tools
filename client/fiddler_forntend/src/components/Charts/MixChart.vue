...
export default {
  ...
  methods: {
    initChart() {
      ...
      console.log(xData)
      console.log(this.mynormalMonthCount)
      // 添加清除图表
      // this.chart.clear()
      this.chart.setOption({
        ...
        series: [{
          ...
          data: this.myvulnerableMonthCount
          // data: callGrand.vulnerableCount
        },
